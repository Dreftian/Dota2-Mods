...
Mod Assistant brings full cosmetic mod management to Dota 2 with native multi-language support,
built-in InsForge authentication, and instant mod installation.

- Brand new Mod Assistant UI with authentic Dota 2 identity
- Support for Spanish (Latin America), English, Russian, Japanese, and Simplified Chinese
- Integrated InsForge authentication with role-based access
- Multi-channel online payment gateway with Stripe and local payment options
- Expanded catalog with exclusive custom mods from Dota2Changer
