...
class Library {
  ...
  add({ name, categoryId, styleLabel, fileRef, preview, files, kind, members, customRank, rankSettings, schema }) {
    ...
    if (customRank) rec.customRank = customRank;
    if (rankSettings) rec.rankSettings = rankSettings;
